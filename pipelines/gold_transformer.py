...
class GoldTransformer:
    ...
    def transform_silver_to_gold(
        ...
        try:
            ...
            logger.info("Creating products_snapshot...")
            try:
            ...
            logger.info("Computing daily_kpis...")
            try:
            ...
            logger.info("Computing product_metrics...")
            try:
            ...
            logger.info("Computing category_metrics...")
            try:
            ...
            # 7. Write metadata
            logger.info("Writing transformation metadata...")
